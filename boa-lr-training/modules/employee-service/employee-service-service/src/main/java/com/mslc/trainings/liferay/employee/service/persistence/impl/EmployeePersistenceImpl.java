...
package com.mslc.trainings.liferay.employee.service.persistence.impl;
...
import com.mslc.trainings.liferay.employee.model.EmployeeTable;
import com.mslc.trainings.liferay.employee.model.impl.EmployeeImpl;
import com.mslc.trainings.liferay.employee.model.impl.EmployeeModelImpl;
import com.mslc.trainings.liferay.employee.service.persistence.EmployeePersistence;
import com.mslc.trainings.liferay.employee.service.persistence.impl.constants.EMPLOYEEPersistenceConstants;
...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public Employee findByName_First(
	 ...
	 */
	@Override
	public Employee fetchByName_First(
		String name, OrderByComparator<Employee> orderByComparator) {
	 ...
	 */
	@Override
	public Employee findByName_Last(
			String name, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {
	 ...
	 */
	@Override
	public Employee fetchByName_Last(
		String name, OrderByComparator<Employee> orderByComparator) {
	 ...
	 */
	@Override
	public Employee[] findByName_PrevAndNext(
	...
	protected Employee getByName_PrevAndNext(
	...
	private static class EmployeeModelArgumentsResolver
		...
		static {
			...
			orderByColumnsBitmask |= EmployeeModelImpl.getColumnBitmask("name");
