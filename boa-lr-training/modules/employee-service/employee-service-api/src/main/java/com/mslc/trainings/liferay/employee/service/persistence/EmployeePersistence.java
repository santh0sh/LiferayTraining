...
package com.mslc.trainings.liferay.employee.service.persistence;
...
public interface EmployeePersistence extends BasePersistence<Employee> {
	 ...
	 * @return the range of matching employees
	 */
	public java.util.List<Employee> findByName(String name, int start, int end);
	 ...
	 * @return the ordered range of matching employees
	 */
	public java.util.List<Employee> findByName(
