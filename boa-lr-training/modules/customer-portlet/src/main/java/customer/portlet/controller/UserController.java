package customer.portlet.controller;

import customer.portlet.dto.User;
...
public class UserController {
	...
	public String prepareView() {
		log.debug("Default View Called");
		return "welcome";
	}

	@RenderMapping(params = "javax.portlet.action=userView")
	public String showUserView()
	{
		log.debug("User View Called");
		return "user";
	}
